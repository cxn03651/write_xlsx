...
class TestRegressionChartDataLabels17 < Test::Unit::TestCase
  def setup
    setup_dir_var
  end
  ...
  def test_chart_data_labels17
    @xlsx = 'chart_data_labels17.xlsx'
    ...
    chart.instance_variable_set(:@axis_ids, [45740032, 45747200])
